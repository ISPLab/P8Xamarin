...
{
	public class P8AbsoluteLayoutBase : Layout<View>, IElementConfiguration<P8AbsoluteLayoutBase>
	{
		...
		readonly Lazy<PlatformConfigurationRegistry<P8AbsoluteLayoutBase>> _platformConfigurationRegistry;
		...
		public P8AbsoluteLayoutBase()
		{
			_children = new AbsoluteElementCollection(InternalChildren, this);
			_platformConfigurationRegistry = new Lazy<PlatformConfigurationRegistry<P8AbsoluteLayoutBase>>(() =>
				new PlatformConfigurationRegistry<P8AbsoluteLayoutBase>(this));
		}

		public IPlatformElementConfiguration<T, P8AbsoluteLayoutBase> On<T>() where T : IConfigPlatform
		{
			return null;//_platformConfigurationRegistry.Value.On<T>();
		}
		...
		{
			public AbsoluteElementCollection(ObservableCollection<Element> inner, P8AbsoluteLayoutBase parent) : base(inner)
			{
				Parent = parent;
			}

			internal P8AbsoluteLayoutBase Parent { get; set; }
